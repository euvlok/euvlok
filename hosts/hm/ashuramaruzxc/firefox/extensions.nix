...
}:
{
  ...
  "floccus" = buildFirefoxXpiAddon {
    ...
    sha256 = "sha256-SBcs8XGHCWArUol3r5vbulReX6K1OeTVLyPXIJFBh0c=";
    meta = with lib; {
      platforms = platforms.all;
      mozPermissions = [
        "*://*/*"
  ...
  "magnolia@12.34" = buildFirefoxXpiAddon {
    ...
    url = "https://gitflic.ru/project/magnolia1234/bpc_uploads/blob/raw?file=bypass_paywalls_clean-latest.xpi&inline=false&commit=8c86c9c2d703dcbe72996e23a422aeee2caa98cd";
