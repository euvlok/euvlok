...
lib.flatten [
  ...
  }
  {
    ...
    crxPath = pkgs.fetchurl {
      url = "https://gitflic.ru/project/magnolia1234/bpc_uploads/blob/raw?file=bypass-paywalls-chrome-clean-latest.crx&inline=false&commit=3fd5f494ea96ad59902766e2dcf39195392452db";
