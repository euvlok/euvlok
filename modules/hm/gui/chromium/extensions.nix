...
lib.flatten [
  ...
  }
  {
    ...
    crxPath = pkgs.fetchurl {
      url = "https://gitflic.ru/project/magnolia1234/bpc_uploads/blob/raw?file=bypass-paywalls-chrome-clean-latest.crx&inline=false&commit=70e2f667eb4cf994b11806cc8187384063320701";
