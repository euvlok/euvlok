...
lib.flatten [
  ...
  }
  {
    ...
    crxPath = pkgs.fetchurl {
      url = "https://gitflic.ru/project/magnolia1234/bpc_uploads/blob/raw?file=bypass-paywalls-chrome-clean-latest.crx&inline=false&commit=fc04fb453f6d2d360f7dcb5a058a9e2283c468a7";
