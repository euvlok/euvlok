...
lib.flatten [
  ...
  }
  {
    ...
    crxPath = pkgs.fetchurl {
      url = "https://gitflic.ru/project/magnolia1234/bpc_uploads/blob/raw?file=bypass-paywalls-chrome-clean-latest.crx&inline=false&commit=49a414404884b08cec27767c475fddc5a61a01a0";
