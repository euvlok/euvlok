...
}:
{
  ...
  "magnolia@12.34" = buildFirefoxXpiAddon {
    ...
    url = "https://gitflic.ru/project/magnolia1234/bpc_uploads/blob/raw?file=bypass_paywalls_clean-latest.xpi&inline=false&commit=d255ef60748c3698077702570609f43517d6ea0f";
