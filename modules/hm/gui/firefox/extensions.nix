...
}:
{
  ...
  "magnolia@12.34" = buildFirefoxXpiAddon {
    ...
    url = "https://gitflic.ru/project/magnolia1234/bpc_uploads/blob/raw?file=bypass_paywalls_clean-latest.xpi&inline=false&commit=cfbdff6851c4081d668e8d683d45ac102ed38b6f";
