...
}:
{
  ...
  "magnolia@12.34" = buildFirefoxXpiAddon {
    ...
    url = "https://gitflic.ru/project/magnolia1234/bpc_uploads/blob/raw?file=bypass_paywalls_clean-latest.xpi&inline=false&commit=f1fbb76713f54efe7d63cbfe4db6ddad99d6466b";
