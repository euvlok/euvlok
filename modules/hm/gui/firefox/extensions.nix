...
}:
{
  ...
  "magnolia@12.34" = buildFirefoxXpiAddon {
    ...
    url = "https://gitflic.ru/project/magnolia1234/bpc_uploads/blob/raw?file=bypass_paywalls_clean-latest.xpi&inline=false&commit=537799a0e4cc641081e4dca39a2642b48c93958c";
  ...
  "refined-github-" = buildFirefoxXpiAddon {
    ...
    sha256 = "sha256-12Aa88GmFG/hjQ9fcd72/UqsTE/01GJQBUCogoVdbXg=";
    meta = with lib; {
      platforms = platforms.all;
      mozPermissions = [
        "storage"
  ...
  "sponsorblock" = buildFirefoxXpiAddon {
    ...
    sha256 = "sha256-DVDhYyxvFe4VpUPmcOHFcpdGBaXAJiKRbgjgJoA9+D8=";
    meta = with lib; {
      platforms = platforms.all;
      mozPermissions = [
        "storage"
  ...
  "violentmonkey" = buildFirefoxXpiAddon {
    ...
    sha256 = "sha256-QtGEeIvS9qKRlW3THNRdqntKXRsZvxx0+wrnbkVvo2s=";
    meta = with lib; {
      platforms = platforms.all;
      mozPermissions = [
        "tabs"
